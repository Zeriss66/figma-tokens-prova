...
import { extractClassSuffixes } from "./theme-helpers.js";
...
class TailwindShowcases extends HTMLElement {
  constructor() {
    super();
    this.theme = {};
  }
  connectedCallback() {
    ...
    if (!supportedKeys.includes(showcaseKey)) {
      this.innerHTML = this.innerHTML + `<p style="color:red;">Other keys than ${supportedKeys.join(", ")} are not yet supported</p>`;
      return;
    }
    const {
      classes,
